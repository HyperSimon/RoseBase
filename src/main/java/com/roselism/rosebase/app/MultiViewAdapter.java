 ...
 */
public abstract class MultiViewAdapter<VH extends MultiViewAdapter.RoseViewHolder, E> extends BaseAdapter {

    protected Context context;
    protected List<E> mData;

    public MultiViewAdapter(@NonNull Context context, @Nullable List<E> data) {
...
//        bindData(position, viewholder); // 为viewholder 绑定数据
    ...
    public abstract class RoseViewHolder {
        View mConvertView;
